...
const itemsPerPage = 5;
  ...
  const styles = `
    ...
    @media (max-width: 768px) {
      ...
      .mobile-table-wrap th.mobile-hide { display: none !important; }
      .mobile-table-wrap td.mobile-hide { display: none !important; }
                  ...
                  <Table hover className="pet-table mobile-table-wrap" style={{ marginBottom: 0, width: '100%' }}>
                    <thead style={{ background: darkMode ? '#1e1e1e' : '#f8f9fa' }}>
                      <tr>
                        ...
                        <th className="mobile-hide" style={{ fontWeight: '600', color: darkMode ? '#aaaaaa' : '#333', padding: '1rem', textAlign: 'center', width: '15%' }}>Owner</th>
                    ...
                    <tbody>
                      ...
                      {Array.from({ length: emptyRows }).map((_, index) => (
                        <tr key={`empty-${index}`} style={{ pointerEvents: 'none', height: '73px' }}>
                          <td colSpan="6" style={{ height: '73px', borderBottom: darkMode ? '1px solid #2a2a2a' : '1px solid #dee2e6', background: darkMode ? '#141414' : '#ffffff', boxSizing: 'border-box' }}></td>
                        </tr>
                      ))}
                    </>
                  );
